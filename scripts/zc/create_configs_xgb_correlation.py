...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--predictor", type=str, default="xgb", help="Predictor to evaluate"
    )
    parser.add_argument("--k", type=int, default=1, help="Number of proxies")
    parser.add_argument(
        "--train_size", type=int, default=400, help="Train set size for predictor"
    )
    parser.add_argument(
        "--test_size", type=int, default=200, help="Test set size for predictor"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="nasbench201",
        help="nasbench101/201/301/transnasbench101",
    )
    parser.add_argument(
        "--experiment", type=str, default="xgb_correlation", help="Experiment type"
    )
