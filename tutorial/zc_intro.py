...
print("*" * 50)
print(
    "Correlations between validation accuracies (ground truth) and Zero Cost predictor scores (prediction): "
)
...
zc_scores = {
    pred: [] for pred in zc_predictors
}  # Just dictionary of an empty list for each predictor
...
kt_corrs_list = sorted(
    kt_corrs_list, reverse=True, key=lambda pred_score_tuple: pred_score_tuple[1]
)
